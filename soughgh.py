...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_camera.setGeometry(QtCore.QRect(70, 120, 971, 411))
        self.frame_camera.setStyleSheet("QFrame{\n"
                                    "background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 rgba(34, 46, 61), stop:1 rgba(34, 34, 47));\n"
                                    "\n"
                                    "border-radius:200px;\n"
                                    "\n"
       ...
       # self.circularProgressCPU = QtWidgets.QFrame(self.frame_camera)
       # self.circularProgressCPU.setGeometry(QtCore.QRect(720, 80, 220, 220))
        ...
        '''self.weather = QtWidgets.QFrame(self.frame_camera)
        ...
        self.circularIndoor = QtWidgets.QFrame(self.frame_camera)
        ...
        #self.checked = AnimatedToggle(self.frame_camera)
        ...
        self.map_plot.setGeometry(self.frame_map.rect())
        self.pushButton_5 = QPushButton(self.frame_camera)
        self.pushButton_5.setObjectName(u"pushButton_5")
        self.pushButton_5.setGeometry(QRect(830, 240, 119, 37))
        sizePolicy.setHeightForWidth(self.pushButton_5.sizePolicy().hasHeightForWidth())
        self.pushButton_5.setSizePolicy(sizePolicy)
        self.pushButton_6 = QPushButton(self.frame_camera)
        ...
        self.webcam = QLabel(self.frame_camera)
        self.webcam.setObjectName(u"webcam")
        self.webcam.setGeometry(QRect(300, 40, 321, 331))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_ac.setText(_translate("MainWindow", "camera"))
    #    self.btn_music.setText(_translate("MainWindow", "MUSIC"))
       ...
       # self.label_33.setText(_translate("MainWindow", "02. Mrittu Utpadon Karkhana - Shonar Bangla Circus"))
        ...
        self.btn_ac.clicked.connect(self.show_camera)
#        self.btn_music.clicked.connect(self.show_Music)
    ...
    def show_Dash(self):
        ...
        self.frame_camera.setVisible(False)
    ...
    def show_camera(self):
        ...
        self.frame_camera.setVisible(True)
        self.frame_map.setVisible(False)
        self.frame_music.setVisible(False)
